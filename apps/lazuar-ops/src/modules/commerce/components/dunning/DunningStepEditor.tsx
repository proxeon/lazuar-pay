                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea 
                        ...
                        disabled={isActionLoading}
                        rows={6}
                        placeholder="Available variables: {{customer_name}}, {{plan_name}}, {{renewal_link}} (hosted bill when minted), {{update_payment_link}}, {{amount}}, {{currency}}, {{current_period_end}}, {{days_overdue}}"
