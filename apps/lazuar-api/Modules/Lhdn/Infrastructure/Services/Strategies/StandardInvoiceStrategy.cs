...
public class StandardInvoiceStrategy : IUblDocumentStrategy
{
    public string Generate(SubmitDocumentRequestDto request, LhdnTenantConfig config, string documentVersion)
    {
        ...
        // 100% hardcoded to perfectly match invoice_template.xml
...
<Invoice xmlns=""urn:oasis:names:specification:ubl:schema:xsd:Invoice-2""
  ...
  <cac:TaxTotal>
    ...
    <cac:TaxSubtotal>
        <cbc:TaxableAmount currencyID=""MYR"">5000.00</cbc:TaxableAmount>
        <cbc:TaxAmount currencyID=""MYR"">0.00</cbc:TaxAmount>
        <cac:TaxCategory>
            <cbc:ID>06</cbc:ID>
  ...
  <cac:LegalMonetaryTotal>
    ...
    <cbc:TaxExclusiveAmount currencyID=""MYR"">5000.00</cbc:TaxExclusiveAmount>
    <cbc:TaxInclusiveAmount currencyID=""MYR"">5000.00</cbc:TaxInclusiveAmount>
    <cbc:PayableAmount currencyID=""MYR"">5000.00</cbc:PayableAmount>
  </cac:LegalMonetaryTotal>
  <cac:InvoiceLine>
    <cbc:ID>1</cbc:ID>
    ...
    <cac:Item>
      <cbc:Description>Software Subscription</cbc:Description>
    ...
    <cac:Price>
      <cbc:PriceAmount currencyID=""MYR"">5000.00</cbc:PriceAmount>
    </cac:Price>
    <cac:ItemPriceExtension>
        <cbc:Amount currencyID=""MYR"">5000.00</cbc:Amount>
    </cac:ItemPriceExtension>
  </cac:InvoiceLine>
</Invoice>";
    }
