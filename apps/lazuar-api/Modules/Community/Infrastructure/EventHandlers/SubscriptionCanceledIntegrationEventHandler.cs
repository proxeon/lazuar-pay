...
public class SubscriptionCanceledIntegrationEventHandler : IIntegrationEventHandler<SubscriptionCanceledIntegrationEvent>
{
    private readonly CommunityDbContext _dbContext;

    public SubscriptionCanceledIntegrationEventHandler(CommunityDbContext dbContext)
    {
