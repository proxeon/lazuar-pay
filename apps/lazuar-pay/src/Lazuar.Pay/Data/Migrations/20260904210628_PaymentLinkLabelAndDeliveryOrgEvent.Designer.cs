...
namespace Lazuar.Pay.Data.Migrations
{
    ...
    [Migration("20260904210628_PaymentLinkLabelAndDeliveryOrgEvent")]
    partial class PaymentLinkLabelAndDeliveryOrgEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lazuar.Pay.Data.RefundRow", b =>
                {
                    ...
                    b.HasIndex(new[] { "CheckoutId" }, "IX_refunds_CheckoutId_late_pay")
                        .IsUnique()
