...
export default function DunningSchedulesPage() {
  ...
  return (
    <PageLayout 
      ...
      description="Automate your revenue collection by scheduling reminders before and after a subscription's due date."
      breadcrumbs={[{ label: "Community", href: "/community/dashboard" }, { label: "Dunning Schedules" }]}
      actionButton={
        <button 
