...
export default function OpsChatWorkspace({
  ...
  const { handleSend, handleActionResolved, isProcessing } = useChatStream(activeConversationId, setMessages);
  ...
  const visibleMessages = messages.filter(
    (m) => m.role !== "system" || m.content.includes("successfully") || m.content.includes("failed")
  );
