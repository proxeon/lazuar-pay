export const en = {
  ...
  "form.taxIdHint": "Required for a Malaysian tax invoice. We validate this TIN / ID pair against MyInvois before pay.",
...
export const ms: Record<MessageKey, string> = {
  ...
  "form.taxIdHint": "Diperlukan untuk invois cukai Malaysia. Kami mengesahkan pasangan TIN / ID ini dengan MyInvois sebelum bayar.",
