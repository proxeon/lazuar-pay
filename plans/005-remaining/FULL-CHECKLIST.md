...
**Source of truth:** individual files in `checklists/`. This file is a concatenated export.  
**Wave:** **Closed** R99 (2026-08-09) — see `r99-notes.md`, `r60-notes.md` (SKIP).
...
- [ ] Expand stable codes on LHDN documents or One provision when editing those endpoints *(skipped — opportunistic)*
