...
head: "297ba98"
resolved_branch: fix/081-hasentry-tenant
---
...
- **Resolved on:** `fix/081-hasentry-tenant`

`HasEntryBeenProcessedAsync` is scoped to `(OrganizationId, ReferenceType, ReferenceId)`.
