...
**Status:** 001–014, 016–018, 020 resolved on `fix/002-pay-host-bugs`. Remaining issues **open**. Resolve one file at a time. Do not edit other issue files while fixing one.
