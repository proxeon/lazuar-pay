...
head: "297ba98"
resolved_branch: fix/031-quote-reuse-hop2-idem-key
---
...
- **Resolved on:** `fix/031-quote-reuse-hop2-idem-key`

OPEN quotes reuse an existing hop-2 URL. Portal idempotency keys include session_id and rotate on 409.
