...
head: "297ba98"
resolved_branch: fix/057-dunning-start-lock
---
...
- **Resolved on:** `fix/057-dunning-start-lock`

Fail handler and billing start-run take `FOR UPDATE` on the subscription before ProcessAsync.
