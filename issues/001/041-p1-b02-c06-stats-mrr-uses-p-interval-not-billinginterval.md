...
head: "297ba98"
resolved_branch: fix/041-stats-mrr-billing-interval
---
...
- **Resolved on:** `fix/041-stats-mrr-billing-interval`

Stats MRR coalesces `BillingInterval` over catalog `Interval` so a yearly seat is 100, not 1200.
